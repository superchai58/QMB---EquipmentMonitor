...
namespace EquipmentMonitor.Laser
{
    class Jutze
    {
        ...
        private Boolean ReadFileToTable(string sFilePath)
        {
            ...
            try
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    if (line.Contains("L030"))
                        continue;
                    
                    if(line.StartsWith("L") && line.Length>14)
                    {                       
                        string sTime = line.Substring(line.Length-15, 14);
                        sTime = sTime.Substring(0, 4) + "-" + sTime.Substring(4, 2) + "-" + sTime.Substring(6, 2) + " " + sTime.Substring(8, 2) + ":" + sTime.Substring(10, 2) + ":" + sTime.Substring(12, 2) + ".000";

                    string sError = line.Substring(1, 10);
