            ...
            try
            {
                ...
                {                    
                    ...
                    */
                    ...
                    {
                        string sTime = line.Substring(0, 8);

                        string sError = line.Substring(line.IndexOf(' ') + 3, line.Length - line.IndexOf(' ') - 3);  //将时间去掉
                        dtTemp.Rows.Add(sTime, sError, "", clsCommon.EQ_SN);
                    }

                }

                string filter = "TransDateTime > '" + m_TimeStamp.ToString("HH:mm:ss") + "' ";
